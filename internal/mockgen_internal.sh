...
TEMP_DIR=$(mktemp -d)
mkdir -p $TEMP_DIR/src/github.com/cyrill-k/quic-go/internalpackage
...
cp -r $GOPATH/src/github.com/cyrill-k/quic-go/internal/* $TEMP_DIR/src/github.com/cyrill-k/quic-go/internalpackage
